...
// Função para desenhar um quadrado de tamnho definido
void ssd1306_square(ssd1306_t *ssd, uint8_t x, uint8_t y, uint8_t size, bool value, bool fill)
{
  ssd1306_rect(ssd, x, y, size, size, value, fill);
}